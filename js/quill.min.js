		...
		null==e&&(e=document.createElement("input"),
				...
				e.addEventListener("change",function(){
					if(null!=e.files&&null!=e.files[0]){
						...
						filedata.append('file_name', e.files[0]);
						
						var _xml = new XMLHttpRequest();
						_xml.open('POST', 'boardUpload.php',true);
					
						_xml.onreadystatechange = function(){
							if(this.readyState == 4 && this.status == 200){
								var r=t.quill.getSelection(!0);
								t.quill.updateContents((new d.default).retain(r.index).delete(r.length).insert({image:this.responseText}),v.default.sources.USER),
