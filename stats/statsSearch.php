...
include_once $_SERVER[DOCUMENT_ROOT].'/m/stats/stats_exec.php';
?>
	...
	<tr>
		...
		<td>
			<div class="store_info"> [ 콜 현황 ] 
				<img src="../images/icon_call_ok.png" width="20px"/>완료콜 : <?=$row['s_cnt']+$row['add_sum']?> / 
				<img src="../images/icon_call_all.png" width="20px"/>전체콜 : <?=$row['cnt']+$row['add_sum']?>
			</div>
		</td>
